    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "מ. פ. מערכות מידע בע\"מ uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '84c314d5-f8e0-409e-b2f8-1821745bf144',
                    name: data.name || '',
                    email: data.email || '',
